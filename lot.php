...
<div class="page-wrapper">
    ...
    <main>
        ...
        <section class="lot-item container">
            ...
            <h2><?=strip_tags($value["title"]); ?></h2>
            <div class="lot-item__content">
                <div class="lot-item__left">
                    <div class="lot-item__image">
                        <img src="<?=$value["img_link"]; ?>" width="730" height="548" alt="Сноуборд">
                    </div>
                    <p class="lot-item__category">Категория: <span><?=strip_tags($value["name"]); ?></span></p>
                    <p class="lot-item__description"><?=strip_tags($value["description"]); ?></p>
                </div>
            <?php endforeach; ?>
